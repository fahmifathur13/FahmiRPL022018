...
import com.example.fahmirpl022018.activity.LoginActivity;
...
public final class Config {
    public static final String BASE_URL = "http://192.168.6.154/fahmi-api-rentalsepeda/";

    private static final String API = "api/";
    public static final String BASE_URL_API = BASE_URL + API;

    public static final String UPLOAD_FOLDER = "img/";
    ...
    public static final String RESPONSE_PAYLOAD_FIELD = "login";
